...
gender-based discrimination.
 ...
 Separate from the Discovery Supercomputing Cluster, our lab also
 uses two \href{https://lambdalabs.com/}{Lambda Labs} ``Scalar'' GPU
 servers with a total of 16 A6000 GPUs and 64 computing cores.  Each
 server has roughly 3~TB of storage, which is shared by the entire
 lab.  Let \director~know if you'd like access to our GPU servers so
 that we can set up your account.
